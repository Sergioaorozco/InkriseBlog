<template>
  <div id="blog-content">
    ...
    <figure class="wrapper px-5">
      <img id="featureImage" :src="postContent.data.featured_image"  class="rounded-2xl h-30 md:h-[400px] w-full object-cover mb-4 -mt-28 sm:-mt-40" alt="">
    </figure>
